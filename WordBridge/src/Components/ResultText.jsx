...
const ResultText = ({ result }) => {
  ...
  return (
    <div className='w-full h-full  p-10 flex flex-col'>
      <p
        placeholder=''
        className="w-full h-full p-10 text-wrap  flex flex-col gap-5 text-lg placeholder:text-2xl bg-[#112137] rounded-2xl text-white resize-none outline-none text-left align-top"
      >
        <button
